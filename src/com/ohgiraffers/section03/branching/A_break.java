...
public class A_break {
    ...
    public void testSimpleBreakStatement2() {
        /* 중첩 반복은 내 berak문 사용에 대한 흐름을 이해하고 적용할 수 있다. */
    ...
    public void testJumpBreak() {
        ...
        label: // 브레이크를 만나면 점프하겠다. < label 이 주어진 키워드가 아니라 원하는대로 작명할 수 있다. 보통은 label사용
        for (;;) {
            for (int i = 0; i < 10; i++) {
                System.out.println(i);
                if (i == 3) {
                    break label; // 브레이크를 만나면 점프하겠다.
                }
            }
        }
    }
